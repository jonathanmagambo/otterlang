...
pub struct RuntimeIntrospector {
    ...
    tiered_compiler: Option<Arc<RwLock<crate::jit::tiered_compiler::TieredCompiler>>>,
...
impl RuntimeIntrospector {
    ...
    pub fn set_tiered_compiler(
        &mut self,
        compiler: Arc<RwLock<crate::jit::tiered_compiler::TieredCompiler>>,
    ) {
    ...
    pub fn get_snapshot(&self) -> RuntimeSnapshot {
        ...
        // Get GC stats
        snapshot.gc_stats = Some(crate::memory::gc::get_gc().collect());
